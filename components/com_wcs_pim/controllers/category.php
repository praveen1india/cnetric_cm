 ...
 * @since  1.6
 */
class Wcs_pimControllerCategory extends JControllerLegacy
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Category', 'Wcs_pimModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_wcs_pim') || $user->authorise('core.edit.state', 'com_wcs_pim'))
		{
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_wcs_pim&view=categories', false));
			}
			else
			{
