...
/**
 * View class for a list of Ucs_users.
 *
 * @since  1.6
 */
class Ucs_usersViewUsers extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Ucs_usersHelper::addSubmenu('users');
	...
	protected function addToolbar()
	{
		...
		$canDo = Ucs_usersHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_UCS_USERS_TITLE_USERS'), 'users.png');
		...
		{
			JToolBarHelper::preferences('com_ucs_users');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_ucs_users&view=users');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_UCS_USERS_USERS_NAME'),
			'a.`company`' => JText::_('COM_UCS_USERS_USERS_COMPANY'),
			'a.`email`' => JText::_('COM_UCS_USERS_USERS_EMAIL'),
			'a.`first_name`' => JText::_('COM_UCS_USERS_USERS_FIRST_NAME'),
			'a.`phone`' => JText::_('COM_UCS_USERS_USERS_PHONE'),
			'a.`last_name`' => JText::_('COM_UCS_USERS_USERS_LAST_NAME'),
		);
	}
}
