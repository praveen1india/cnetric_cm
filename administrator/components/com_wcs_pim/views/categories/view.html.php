 ...
 * @since  1.6
 */
class Wcs_pimViewCategories extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Wcs_pimHelpersWcs_pim::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_WCS_PIM_TITLE_CATEGORIES'), 'categories.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_wcs_pim&view=categories');
