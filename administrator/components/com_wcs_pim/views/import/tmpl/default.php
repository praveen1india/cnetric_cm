...
<form action="<?php echo JRoute::_('index.php?option=com_wcs_pim&view=import'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			/*$model = JModelLegacy::getInstance('Extractor', 'Wcs_pimModel');
						...
						print_r($items);*/
			 ?>
			<div id="Main-bar" class="btn-toolbars">
				<p>Select CSV to upload:</p>

   				 <input type="file" name="CatUpload" id="CatUpload">
