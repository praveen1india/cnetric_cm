 ...
 * @since  1.6
 */
class Wcs_pimViewCategory extends JViewLegacy
{
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		$Data_Roews						= Wcs_pimHelpersWcs_pim::GetData();
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_WCS_PIM_TITLE_CATEGORY'), 'category.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_wcs_pim.category', $this->item->id);
		}
